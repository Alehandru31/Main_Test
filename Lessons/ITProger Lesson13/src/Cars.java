...
// Mai jos noi vedem constructor pentru Cars care primeste parametrii de la Honda
     public Cars(float speed, int weight, String colors, byte[] coordinate) { //se formeaza un constructor cu
         // modificator dostupa public si primeste 4 parametri
         System.out.println("Honda: ");
         setCars(speed, weight, colors, coordinate); //apelam la setCar Unde instalam prin
         // parametri speed, in palea clasa (this.speed) datele de la metod
